  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        variant === "destructive" && "destructive group border-red-500 bg-red-500 text-slate-50",
        variant === "success" && "success group border-green-500 bg-green-500 text-slate-50",
        className,
      )}
      {...props}
    />
